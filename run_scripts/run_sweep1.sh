...
srun --cpu-bind=cores python run_sbi_mp.py all s0_s1_s2
srun --cpu-bind=cores python run_sbi_mp.py all s1_s2
srun --cpu-bind=cores python run_sbi_mp.py all None