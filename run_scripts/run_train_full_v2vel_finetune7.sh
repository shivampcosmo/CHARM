#!/bin/bash
#SBATCH --job-name=charm_v2vel_ft7
#SBATCH --nodes=3
...
#SBATCH -p gpu
#SBATCH --output=/mnt/ceph/users/spandey/CHARM_v2/CHARM/logs/train_full_v2vel_ft7_%j.out
#SBATCH --error=/mnt/ceph/users/spandey/CHARM_v2/CHARM/logs/train_full_v2vel_ft7_%j.err

set -euo pipefail

REPO=/mnt/ceph/users/spandey/CHARM_v2/CHARM
CONFIG=$REPO/run_configs/TRAIN_CHARM_JOINT_v2vel_finetune7.yaml
