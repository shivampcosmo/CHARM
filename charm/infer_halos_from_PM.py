...
class get_model_interface:
    ...
    def __init__(self, run_config_massNtot_name='train_massNtot_config.yaml', run_config_vel_name='train_vel_config.yaml', 
        ...
        try:
            ...
            with open(f"{curr_path}/trained_configs/{run_config_massNtot_name}", "r") as file_object:
                config = yaml.load(file_object, Loader=yaml.SafeLoader)
        ...
        try:
            checkpoint = torch.load(trained_massmodel_name, map_location=dev)
        except:
            save_bestfit_model_name = f'{curr_path}/trained_models/{trained_massmodel_name}'
        ...
        try:
            with open(run_config_vel_name, "r") as file_object:
                config_vel = yaml.load(file_object, Loader=yaml.SafeLoader)
        except:
            with open(f"{curr_path}/trained_configs/{run_config_vel_name}", "r") as file_object:
                config_vel = yaml.load(file_object, Loader=yaml.SafeLoader)
        ...
        try:
            checkpoint = torch.load(trained_velmodel_name, map_location=dev)
        except:
            save_bestfit_model_name = f'{curr_path}/trained_models/{trained_velmodel_name}'
            checkpoint = torch.load(save_bestfit_model_name, map_location=dev)
