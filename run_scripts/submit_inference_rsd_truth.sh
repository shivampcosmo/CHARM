...
srun python run_inference.py rsd mono SNRE truth
srun python run_inference.py rsd quad SNRE truth
srun python run_inference.py rsd all SNRE truth
srun python run_inference.py real mono SNRE truth