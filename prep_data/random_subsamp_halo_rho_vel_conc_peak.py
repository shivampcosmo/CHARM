...
run_config_name = f'TRAIN_PEAK_FREECOSMO_cond_fastpm_ns128_{mass_type}.yaml'
...
df = pk.load(open(f'/mnt/home/spandey/ceph/CHARM/data/DENSITY_varycosmo_subsel_random_nsims{nsims}_nspji{nsubvol_per_ji}_nfid{nsubvol_fid}_train_data_FASTPM.pk', 'rb'))
...
import pickle as pk
nsims = int(config_sims['nsims'])
pk.dump(saved, open('/mnt/home/spandey/ceph/CHARM/data/' + f'HALO_MASS_{mass_type}_VEL_NU_CONC_varycosmo_subsel_random_nsims{nsims}_nspji{nsubvol_per_ji}_nfid{nsubvol_fid}' + '_train_data_QUIJOTE.pk', 'wb'))
