#!/bin/bash
#SBATCH --job-name=charm_v2vel_ft9
#SBATCH --nodes=3
...
#SBATCH -p gpu
#SBATCH --output=/mnt/ceph/users/spandey/CHARM_v2/CHARM/logs/train_full_v2vel_ft9_%j.out
#SBATCH --error=/mnt/ceph/users/spandey/CHARM_v2/CHARM/logs/train_full_v2vel_ft9_%j.err

set -euo pipefail

REPO=/mnt/ceph/users/spandey/CHARM_v2/CHARM
CONFIG=$REPO/run_configs/TRAIN_CHARM_JOINT_v2vel_finetune9.yaml
